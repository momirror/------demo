...
- (NSString *)titleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        switch (indexPath.row)
        {
            ...
            case 6   : title = @"导航点ID";    break;
            case 7   : title = @"入口经纬度";   break;
            case 8   : title = @"出口经纬度";   break;
            case 9   : title = @"权重";        break;
            case 10  : title = @"匹配";        break;
            case 11  : title = @"推荐标识";     break;
            case 12  : title = @"时间戳";       break;
            case 13  : title = @"团购信息数目";  break;
            case 14  : title = @"优惠信息数目";  break;
            case 15  : title = @"团购与优惠";    break;
...
- (NSString *)subTitleForIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        switch (indexPath.row)
        {
            ...
            case 3  : subTitle = self.poi.citycode;      break;
            case 4  : subTitle = self.poi.adcode;        break;
            ...
            case 9  : subTitle = TemporaryNotOpened;    break;
            ...
            case 13 : subTitle = [NSString stringWithFormat:@"%d", self.poi.groupbuyNum];  break;
            case 14 : subTitle = [NSString stringWithFormat:@"%d", self.poi.discountNum];  break;
            case 15 : subTitle = nil;                   break;
            default : subTitle = self.poi.direction;    break;
        }
    }
...
{
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"团购与优惠"
                                                                              style:UIBarButtonItemStyleBordered
                                                                             target:self action:@selector(richContentAction)];
    
    /* 如果团购与优惠无有效数据, disable rightBarButtonItem. */
    self.navigationItem.rightBarButtonItem.enabled = (self.poi.richContent.groupbuys.count != 0) || (self.poi.richContent.discounts.count != 0);
}
